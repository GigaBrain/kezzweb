...
!function (e) {
    ...
    }, e(document).on("click.alert.data-api_fake", t, n.prototype.close)
}(window.jQuery), !function (e) {
    "use strict";
    var t = function (t, n) {
    ...
    }, e(document).on("click.button.data-api_fake", "[data-toggle^=button]", function (t) {
        var n = e(t.target);
    ...
    }, e(document).on("click.carousel.data-api_fake", "[data-slide], [data-slide-to]", function (t) {
    ...
    }, e(document).on("click.collapse.data-api_fake", "[data-toggle=collapse]", function (t) {
    ...
    var t = "[data-toggle=dropdown]", n = function (t) {
        var n = e(t).on("click.dropdown.data-api_fake", this.toggle);
        e("html").on("click.dropdown.data-api_fake", function () {
    ...
    }, e(document).on("click.dropdown.data-api_fake", r).on("click.dropdown.data-api_fake", ".dropdown form", function (e) {
        e.stopPropagation()
    }).on("click.dropdown.data-api_fake", t, n.prototype.toggle).on("keydown.dropdown.data-api_fake", t + ", [role=menu]", n.prototype.keydown)
}(window.jQuery), !function (e) {
    "use strict";
    var t = function (t, n) {
    ...
    }, e(document).on("click.modal.data-api_fake", '[data-toggle="modal"]', function (t) {
    ...
    function t(t, n) {
        ...
        this.options = e.extend({}, e.fn.scrollspy.defaults, n), this.$scrollElement = i.on("scroll.scroll-spy.data-api_fake", r), this.selector = (this.options.target || (s = e(t).attr("href")) && s.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a", this.$body = e("body"), this.refresh(), this.process()
    }
    ...
    }, e(document).on("click.tab.data-api_fake", '[data-toggle="tab"], [data-toggle="pill"]', function (t) {
    ...
    }, e(document).on("focus.typeahead.data-api_fake", '[data-provide="typeahead"]', function (t) {
        var n = e(this);
    ...
    "use strict";
    var t = function (t, n) {
        this.options = e.extend({}, e.fn.affix.defaults, n), this.$window = e(window).on("scroll.affix.data-api_fake", e.proxy(this.checkPosition, this)).on("click.affix.data-api_fake", e.proxy(function () {
